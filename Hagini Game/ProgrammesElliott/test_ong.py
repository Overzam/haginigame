...
track = pyg.image.load('img/track_border.png')
...
checkpoint = pyg.transform.scale(checkpoint, (int(40*width/1100), int(200*height/600))).convert_alpha()
...
x_offset, y_offset = -1240,-3260
circuit = Background((x_offset,y_offset), 6, 2, track, track_border_mask)

abs_x, abs_y = 1.397, 1.441
# Tableau d'objets
objets = [[[0,0],track_border,(0,1,0,0,None)],
             [[1910, 3760], checkpoint_horizontal,(1,0,0,1,None)],
             [[1570,2050],checkpoint_horizontal,(1,0,0,1,None)],
             [[318,530],crosshair,(0,0,0,0,2)],
             [[415,480],crosshair,(0,0,0,0,2)],
             [[522,530],crosshair,(0,0,0,0,2)],
             [[619,480],crosshair,(0,0,0,0,2)]]
